...
LOGGER_ID = int(getenv("LOGGER_ID", -1002116094200))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO", "https://github.com/Sumitmeena12/LB_Music", # dont Change this otherwise u get error 🧧
)
...
SUPPORT_CHAT = getenv("SUPPORT_GROUP", "https://t.me/apnihavelixd")
